...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "I&E Tile Services" },
      { property: "og:title", content: "I&E Tile Services" },
      { name: "twitter:title", content: "I&E Tile Services" },
      { name: "description", content: "I&E Bathrooms" },
      { property: "og:description", content: "I&E Bathrooms" },
      { name: "twitter:description", content: "I&E Bathrooms" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/JDnBRxYLBHggj1MkbkIbPSzyjYt2/social-images/social-1779795553316-9cfef0b2-d574-493c-89c5-38d158c4488e.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/JDnBRxYLBHggj1MkbkIbPSzyjYt2/social-images/social-1779795553316-9cfef0b2-d574-493c-89c5-38d158c4488e.webp" },
    ],
    links: [
